...
use App\Entity\AuditTrail\TagAuditTrail;
...
class TagAuditTrailRepository extends ServiceEntityRepository
{
    ...
    // /**
    //  * @return TagAuditTrail[] Returns an array of TagAuditTrail objects
    //  */
    /*
    ...
    */
    ...
    /*
    public function findOneBySomeField($value): ?TagAuditTrail
    {
        return $this->createQueryBuilder('t')
            ->andWhere('t.exampleField = :val')
            ->setParameter('val', $value)
